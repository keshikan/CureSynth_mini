...
__ALIGN_BEGIN uint8_t USBD_MIDI_CfgDesc[USB_MIDI_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  0x09, 0x02, ((69 + 13*MIDI_IN_JACK_NUM + 19*MIDI_OUT_JACK_NUM-3-13) & 0xFF)/*0x45 total size of cdesc*/, ((69 + 13*MIDI_IN_JACK_NUM + 19*MIDI_OUT_JACK_NUM-3-13) & 0xFF00) >> 8, 0x02, 0x01, 0x00, 0x80, 0x64,
