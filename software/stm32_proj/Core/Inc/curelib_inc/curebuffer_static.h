 ...
 *******************************************************************************
 *  [curebuffer.h]
 *  This module is for FIFO buffer for static allocation.
 *
...
/////////////////////////////
extern BUFFER_STATUS cureRingBufferU8Init(RingBufferU8 *rbuf, uint32_t buf_len, uint8_t* buf_ptr);
...
/////////////////////////////
extern BUFFER_STATUS cureRingBuffer16Init(RingBuffer16 *rbuf, uint16_t buf_len, int16_t* buf_ptr);
...
/////////////////////////////
extern BUFFER_STATUS cureRingBufferU32Init(RingBufferU32 *rbuf, uint16_t buf_len, uint32_t* buf_ptr);
extern BUFFER_STATUS cureRingBufferU32Free(RingBufferU32 *rbuf);
extern BUFFER_STATUS cureRingBufferU32Enqueue(RingBufferU32 *rbuf, uint32_t *inputc);
extern BUFFER_STATUS cureRingBufferU32EnqueueIgnoreErr(RingBufferU32 *rbuf, uint32_t *inputc);
extern BUFFER_STATUS cureRingBufferU32Dequeue(RingBufferU32 *rbuf, uint32_t *ret);
extern BUFFER_STATUS cureRingBufferU32GetElement(RingBufferU32 *rbuf, uint32_t *ret, uint32_t delaynum, uint32_t delay_buffer_length);
